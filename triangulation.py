...
def draw_point(img, p, color ) :
    cv2.circle( img, p, 2, color, cv2.FILLED, 0, 0 )
...
def draw_delaunay(img, subdiv, delaunay_color ) :
    ...
    for t in triangleList :
        ...
        if rect_contains(r, pt1) and rect_contains(r, pt2) and rect_contains(r, pt3) :
            cv2.line(img, pt1, pt2, delaunay_color, 1, 0, 0)
            cv2.line(img, pt2, pt3, delaunay_color, 1, 0, 0)
            cv2.line(img, pt3, pt1, delaunay_color, 1, 0, 0)
...
def draw_voronoi(img, subdiv):
    ...
    for i in range(0,len(facets)) :
        ...
        cv2.circle(img, (centers[i][0], centers[i][1]), 3, (0, 0, 0), cv2.FILLED, 0, 0)
...
if __name__ == '__main__':
    ...
    # print("subdiv triangled:", subdiv.getTriangleList())
    # Draw points
    for p in points :
